class LoginusersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @loginuser.save
        format.html { redirect_to loginusers_url, notice: 'Loginuser was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @loginuser.update(loginuser_params)
        format.html { redirect_to loginusers_url, notice: 'Loginuser was successfully updated.' }
  ...
  private
    ...
    def loginuser_params
      params.require(:loginuser).permit(:name, :password, :password_confirmation)
    end
end
